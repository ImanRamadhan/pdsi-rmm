...
{
    public class LaporanKinerjaMovingRIGController : Controller
    {
        // GET: LaporanKinerjaMovingRIG
        [Authorize]
        ...
        public ActionResult Search(string area, string rig, DateTime? tglmulaiStrt, DateTime? tglmulaiEnd)
        {
            DB_RMMEntities DB = new DB_RMMEntities();
            ...
            return PartialView("PartialPageDataKinerja");
        }

        public JsonResult GetData(string area, string rig, DateTime? tglmulaiStrt, DateTime? tglmulaiEnd)
        {
            DB_RMMEntities DB = new DB_RMMEntities();
            ResponseMessage Response = new ResponseMessage();
            string username = Session["Newusername"].ToString();
        ...
        public JsonResult GetDataBar(string area, string rig, DateTime? tglmulaiStrt, DateTime? tglmulaiEnd)
        {
            DB_RMMEntities DB = new DB_RMMEntities();
            ResponseMessage Response = new ResponseMessage();
            string username = Session["Newusername"].ToString();
        ...
        public JsonResult Doc(string area, string rig, DateTime? tglmulaiStrt, DateTime? tglmulaiEnd)
        {
            DB_RMMEntities DB = new DB_RMMEntities();
            ResponseMessage Response = new ResponseMessage();
            ...
            dataSearch = dataSearch.GroupBy(q => q.rig).Select(q => q.First()).ToList();
            int r = 1;
            var no = (from d in dataSearch
                      select new LaporanRekapData
                      {
                          nomor = r++,
                      }
