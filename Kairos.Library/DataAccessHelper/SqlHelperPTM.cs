...
{
    public static class SqlHelperPTM
    {
        #region " Connection "
        //-----------------------------------
...
//-----------------------------------
        ...
        //-----------------------------------
        public static object DoSqlNonQuery(SqlConnection conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters)
        {
            return DoSqlNonQuery(conn, SqlType, SqlText, parameters, null);
        }
        ...
        public static object DoSqlNonQuery(SqlConnection conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters, SqlTransaction trans)
        {
            return DoSqlNonQuery(conn, SqlType, SqlText, parameters, trans, 0);
        }

        public static object DoSqlNonQuery(SqlConnection conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters, SqlTransaction trans, int timeout = 0)
        {
            int result = 0;
            SqlCommand cmd = new SqlCommand();
            try
        ...
        //-----------------------------------
        public static SqlDataReader GetDataReader(SqlConnection Conn, string SqlText, CommandType SqlType, List<SqlParameter> parameters)
        {
            return GetDataReader(Conn, SqlType, SqlText, parameters, 0);
        }

        public static SqlDataReader GetDataReader(SqlConnection Conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters, int timeout = 0)
        {
            SqlCommand cmd = new SqlCommand();
            try
            {
        ...
        public static DataTable PopulateDataTable(SqlConnection Conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters, int timeout = 0)
        {
            ...
            SqlDataReader dr = GetDataReader(Conn, SqlType, SqlText, parameters, timeout);
            Result.Load(dr);
            return Result;
        }
        ...
        public static DataTable PopulateDataTable(SqlConnection Conn, string TableName, string clause = "", int timeout = 0)
        {
            DataTable result = new DataTable();
        ...
        public static object DoSqlAggregateQuery(SqlConnection conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters)
        {
            return DoSqlAggregateQuery(conn, SqlType, SqlText, parameters, 0);
        }

        public static object DoSqlAggregateQuery(SqlConnection conn, CommandType SqlType, string SqlText, List<SqlParameter> parameters, int timeout = 0)
        {
            SqlCommand cmd = new SqlCommand();
            try
            {
                cmd = GetSqlCommand(CommandType.Text, SqlText, conn, null, timeout);
                if (parameters != null)
                    AddCommandParameters(cmd, parameters);
                if (cmd.Connection.State != ConnectionState.Open)
                    cmd.Connection.Open();
        ...
        public static List<object> GetColumnValues(SqlConnection Conn,
                                                            ...
                                                            string Restrictions = "")
        {
            return GetColumnValues(Conn, TableName, ColumnName, isDistinct, Restrictions, "", 0);
        }
        ...
        public static List<object> GetColumnValues(SqlConnection Conn,
                                                            ...
                                                            string OrderColumn = "")
        {
            return GetColumnValues(Conn, TableName, ColumnName, isDistinct, Restrictions, OrderColumn, 0);
        }
                                                            ...
                                                            int timeout = 0)
        {
            ...
            SqlDataReader dr = GetDataReader(Conn, CommandType.Text, SqlTxt, null, timeout);
            if (dr != null)
            {
                if (dr.HasRows)
                {
